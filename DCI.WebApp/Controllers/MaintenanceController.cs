...
namespace DCI.WebApp.Controllers
{
    public class MaintenanceController : Controller
    {
        ...
        public async Task<IActionResult> ChangeStatusAnnouncement(AnnouncementViewModel model)
        {
            try
            {
                using (var _httpclient = new HttpClient())
                {
                    ...
                    var stringContent = new StringContent(JsonConvert.SerializeObject(model), Encoding.UTF8, "application/json");
                    var request = new HttpRequestMessage(HttpMethod.Post, _apiconfig.Value.apiConnection + "api/Maintenance/ChangeStatusAnnouncement");
        ...
        public async Task<IActionResult> Holiday()
        {
            try
            {
                List<HolidayViewModel> model = new List<HolidayViewModel>();

                using (var _httpclient = new HttpClient())
                {
                    HttpResponseMessage response = await _httpclient.GetAsync(_apiconfig.Value.apiConnection + "api/Maintenance/GetAllHoliday");
                    string responseBody = await response.Content.ReadAsStringAsync();

                    if (response.IsSuccessStatusCode)
                    {
                        model = JsonConvert.DeserializeObject<List<HolidayViewModel>>(responseBody)!;
                    }
                }
                return View(model);
            }
        ...
        public async Task<IActionResult> EditHoliday(HolidayViewModel model)
        {
            try
            {
                ...
                {
                    var stringContent = new StringContent(JsonConvert.SerializeObject(model), Encoding.UTF8, "application/json");
                    var request = new HttpRequestMessage(HttpMethod.Post, _apiconfig.Value.apiConnection + "api/Maintenance/GetHolidayById");
                    request.Content = stringContent;
                    var response = await _httpclient.SendAsync(request);
                    var responseBody = await response.Content.ReadAsStringAsync();
                    HolidayViewModel vm = JsonConvert.DeserializeObject<HolidayViewModel>(responseBody)!;
        ...
        public async Task<IActionResult> SaveHoliday(HolidayViewModel model)
        {
            try
            {
                using (var _httpclient = new HttpClient())
                {
                    ...
                    var stringContent = new StringContent(JsonConvert.SerializeObject(model), Encoding.UTF8, "application/json");
                    var request = new HttpRequestMessage(HttpMethod.Post, _apiconfig.Value.apiConnection + "api/Maintenance/SaveHoliday");
        ...
        public async Task<IActionResult> DeleteHoliday(HolidayViewModel model)
        {
            try
            {
                using (var _httpclient = new HttpClient())
                {
                    ...
                    var stringContent = new StringContent(JsonConvert.SerializeObject(model), Encoding.UTF8, "application/json");
                    var request = new HttpRequestMessage(HttpMethod.Post, _apiconfig.Value.apiConnection + "api/Maintenance/DeleteHoliday");
        ...
        public async Task<IActionResult> OfficeOrder()
        {
            try
            {
                List<OfficeOrderViewModel> model = new List<OfficeOrderViewModel>();

                using (var _httpclient = new HttpClient())
                {
                    HttpResponseMessage response = await _httpclient.GetAsync(_apiconfig.Value.apiConnection + "api/Maintenance/GetAllOfficeOrder");
                    string responseBody = await response.Content.ReadAsStringAsync();

                    if (response.IsSuccessStatusCode)
                    {
                        model = JsonConvert.DeserializeObject<List<OfficeOrderViewModel>>(responseBody)!;
                    }
                }
                return View(model);
            }
        ...
        public async Task<IActionResult> EditOfficeOrder(int OfficeOrderId)
        {
            try
            {
                using (var _httpclient = new HttpClient())
                {
                    OfficeOrderViewModel model = new OfficeOrderViewModel();
                    model.OfficeOrderId = OfficeOrderId;
                    var stringContent = new StringContent(JsonConvert.SerializeObject(model), Encoding.UTF8, "application/json");
                    var request = new HttpRequestMessage(HttpMethod.Post, _apiconfig.Value.apiConnection + "api/Maintenance/GetOfficeOrderById");
                    request.Content = stringContent;
                    var response = await _httpclient.SendAsync(request);
                    var responseBody = await response.Content.ReadAsStringAsync();
                    OfficeOrderViewModel vm = JsonConvert.DeserializeObject<OfficeOrderViewModel>(responseBody)!;
        ...
        public async Task<IActionResult> SaveOfficeOrder(OfficeOrderViewModel model)
        {
            try
            {
                using (var _httpclient = new HttpClient())
                {
                    ...
                    var stringContent = new StringContent(JsonConvert.SerializeObject(model), Encoding.UTF8, "application/json");
                    var request = new HttpRequestMessage(HttpMethod.Post, _apiconfig.Value.apiConnection + "api/Maintenance/SaveOfficeOrder");
        ...
        public async Task<IActionResult> DeleteOfficeOrder(OfficeOrderViewModel model)
        {
            try
            {
                using (var _httpclient = new HttpClient())
                {
                    ...
                    var stringContent = new StringContent(JsonConvert.SerializeObject(model), Encoding.UTF8, "application/json");
                    var request = new HttpRequestMessage(HttpMethod.Post, _apiconfig.Value.apiConnection + "api/Maintenance/DeleteOfficeOrder");
