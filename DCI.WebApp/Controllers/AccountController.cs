...
namespace DCI.WebApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ChangePassword(ValidatePasswordTokenViewModel model)
        {
            // ValidatePasswordTokenViewModel model = new ValidatePasswordTokenViewModel();
            ...
            try
            {
                ...
                {
                    var stringContent = new StringContent(JsonConvert.SerializeObject(model), Encoding.UTF8, "application/json");
                    var request = new HttpRequestMessage(HttpMethod.Post, _apiconfig.Value.apiConnection + "api/Account/ValidatePasswordToken");
